...
The 'Configuration' tab <img src="/img/config_icon_2.png" width="15rem"  style="display: inline"> shows the components configurations, grouped by each extension used by it. That also includes _all_ its dependencies (under the `@teambit.pkg/pkg` packager extension).

For example:
<img src="/img/pkg_config.png" width="70%" >
...
The 'History' tab <img src="/img/log_icon.png" width="15rem"  style="display: inline"> show a component's version history. The different versions can be explored further by clicking on their links.

For example:

<img src="/img/log_example.png">
