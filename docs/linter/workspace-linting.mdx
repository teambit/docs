...
During development, Bit lints your components using the `bit lint`. That command
provides a standard dev experience for linting any kind of [Component](#), whether it is a NodeJS modules,
a React component or anything else.

## Lint all components in the Workspace

Bit lints all components in the [Workspace](/workspace/overview) regardless to the configured [Env](/envs/overview) and therefor tester,
