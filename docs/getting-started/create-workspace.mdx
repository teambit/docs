...
Learn how to create a workspace as well as how to reset a workspace or create your own custom workspace.
...
```bash
├── workspace.jsonc  # workspace configuration file
├── .bitmap  # maps your components from your local directory
├── .bit #  this should be added to .gitignore
└── public  # this should be added to .gitignore
```
