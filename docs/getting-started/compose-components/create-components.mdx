...
Learn what a Bit component is and how to create one using the component generator. Learn how to add styles and environments to your components so you can have components from other frameworks such as React and Angular in the same workspace. If you already have components created you can use a command to add them to your workspace and even remove or move them to another directory.
