...
Creating components can be done with a single command using our component generator. To see a list of available component templates run the `bit templates` command.
...
You can also create your own component templates with with your preferred styling using our [component generator](/).
...
:::tip
To delete the components files as well as delete them from the bitmap use the `--delete` flag.
:::
