...
Learn how to add documentation to your components and how the we use prop-types to generate docs and how to add a live-playground for consumers to really be able to play with your component before using it. Learn how to add tests and compositions so you can render your components in different contexts. We also go through linting and formating and how to compile and build your components.
