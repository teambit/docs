...
Each Bit component comes with it's own documentation which can be manually added as well as generated through prop-types. Components should have tests which are visible in the UI during development and compositions so you can render your components in different contexts. Bit components can also be linted, formatted, and compiled using the configuration of your choice.
