...
Learn how to install a dependency to your workspace and how Bit automates dependency management. Learn how to change a dependency type and how to work with policies to assign different versions of dependencies to components in the same project.
