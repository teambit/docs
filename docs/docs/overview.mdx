...
The Docs Service simplifies and standardizes component documentation. It loads the doc files from the Component Directories, and displays them using the doc template that was set by each component's Env.
