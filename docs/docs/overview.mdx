...
The Docs service simplifies and standardizes component documentation. It loads the doc files from the workspace's [component directories](/workspace/component-directory), and displays them using the [doc template](/doc-templates) that was set by each component's Env.
...
To override the default glob patterns, use the Docs config interface:
