...
Example Project: [Learn-Bit-React](/)
Repo of team ECommerce -> 
Repo of team Stores team -> 
...
Building a component model facilitates a bottom-up approach, as with atomic components teams can compose more specialized components, all the way to composing applications.  
...
[Visual] -> Showing Graph distributed to different teams owning features (groups of components/NGModules/etc.)

### Benefits

Scaling component model to building Micro Frontends can help teams deliver higher quality user experiences and avoid the constrains of
the browser.  
...
- Any one can change and modify any code. (import)
...
## Styling and Theming
Encapsulating styles in components will allow better control over using APIs and dependencies.
