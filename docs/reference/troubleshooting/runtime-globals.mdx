...
1. Create a new [environment extension](/envs/customizing-env).
...
Set both environment services, the Preview and DevServer <!--TODO ['Preview'](/building-with-bit/environments#preview) and ['DevServer'](/building-with-bit/environments#devserver) -->, to use the new Webpack configurations (these new configurations will be the result of the merge between the new configurations set in the extension, with the previous configurations).
