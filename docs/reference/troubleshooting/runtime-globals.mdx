...
Set both environment services, the Preview and DevServer <!--TODO ['Preview'](/envs/overvew#preview) and ['DevServer'](/envs/overvew#devserver) -->, to use the new Webpack configurations (these new configurations will be the result of the merge between the new configurations set in the extension, with the previous configurations).
