...
1. Create a new [environment extension](/bit-environments/environments).
...
Set both environment services, the ['Preview'](/bit-environments/environments#preview) and ['DevServer'](/bit-environments/environments#devserver), to use the new Webpack configurations (these new configurations will be the result of the merge between the new configurations set in the extension, with the previous configurations).
