...
React's environment transformers enable merging new configurations for different [Bit aspects used by the React environment](/environment/environment-services).
