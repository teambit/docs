...
cd my-workspace
bit install get david to fix this
bit start
```
...
The following command will add a new component to your workspace under the [namespace](/) of 'ui' and in the [path](/) of 'templates'.

```bash
bit create react templates/ui/my-component --path templates
```
...
TODO: Improve cli message here so it points to the right place
...
- NPM: `npm install @teambit/base-ui.my-component`
- Yarn: `yarn add @teambit/base-ui.my-component`
