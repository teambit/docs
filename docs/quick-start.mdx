...
Just make sure to [configure the Bit registry](/) if you are using Bit's cloud provider.
...
from any project or Bit Workspace. You can then export a new version and even eject it from your workspace.
