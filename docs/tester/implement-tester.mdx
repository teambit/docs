...
## Tester main runtime file

## Methods for testing during build
...
## Methods for the main runtime

Create an instance of a class that implements the Tester` interface
